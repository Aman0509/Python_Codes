...
This script randomly chooses a number to guess and then the user will have a few chances to guess the number correctly.
...
while True:
    ...
    if ans == "Y" or ans == "YES":
        ...
        print("\nCool!!")
        time.sleep(0.2)
        print("Tell me what number I am thinking right now. Mind you, you have only 3 attemtpts to guess it right, "
              "so GOOD LUCK!!")
            ...
            if user_num == guessed_value:
                ...
                while h == True and counter > 0:
                    ...
                    if hint == "Y" or hint == "YES":
                        ...
                        print(
                            f'I can\'t tell you correctly but you are "ALMOST" {hint_val} {hint_msg} from my guessed number\n')
                        h = False
